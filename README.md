...
1. In order to add buttons to the chat flow you will notice the button script has already been created within index.html
  ![Button Script](readme_images/buttonscript.png)

  This can be modified to change the command required to be sent within the chat.
